...
$(function(){
	...
	$.getJSON(getHrInfoUrl,function(data){
		...
		newsObj.map(function(item,data){
			outHtml2+='<tr><td>'+item.aac101+'</td><td>'+item.aac102+'</td><td>'+item.aac112+'</td><td><a href="/gxttcc/cps/brief?a=4&b=2&c='+item.aac101+'" >删除</a>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/gxttcc/cps/brief?b=1&c='+item.aac101+'" >编辑</a></td></tr>';
		});//
