...
$(function(){
	...
	outHtml1='<tr><th>网站名称</th><th>备案号</th><th>邮箱</th><th>编辑</th></tr><tr>';
	outHtml2='';
	
	$.getJSON(getAddressUrl+1,function(data){
		var newsObj=data.add;
		
		outHtml2='<tr><td>'+newsObj.addName+'</td><td>'+newsObj.addContent+'</td><td>'+newsObj.addEmail+'</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/gxttcc/cps/brief?b=1&c='+newsObj.aac101+'" >编辑</a></td></tr>';
		
		$('#bot-index').html(outHtml1+outHtml2);
	});
	outHtml1='<tr><th>公司名</th><th>地址</th><th>联系人</th><th>电话</th><th>编辑</th></tr><tr>';
	outHtml2='';
	$.getJSON(getAddressUrl+2,function(data){
		var newsObj1=data.add;
		outHtml2='<tr><td>'+newsObj1.addName+'</td><td>'+newsObj1.addContent+'</td><td>'+newsObj1.addPhoneOwner+'</td>><td>'+newsObj1.addPhoneNumber+'</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/gxttcc/cps/brief?b=1&c='+newsObj1.aac101+'" >编辑</a></td></tr>';
		$('#bot-index').html(outHtml1+outHtml2);
		$.getJSON(getAddressUrl+3,function(data){
			var newsObj2=data.add;
			outHtml2+='<tr><td>'+newsObj2.addName+'</td><td>'+newsObj2.addContent+'</td><td>'+newsObj2.addPhoneOwner+'</td>><td>'+newsObj2.addPhoneNumber+'</td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<a href="/gxttcc/cps/brief?b=1&c='+newsObj2.aac101+'" >编辑</a></td></tr>';
			$('#bot-index').html(outHtml1+outHtml2);
		});
	});
})